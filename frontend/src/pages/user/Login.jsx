            ...
            <form onSubmit={handleSubmit} className='space-y-4'>
                ...
                <div>
                    ...
                    <div className='relative'>
                        ...
                        <span className='absolute inset-y-0 end-2 grid place-items-center px-4'><MdAlternateEmail className='h-4 w-4 text-gray-400'/></span>
                    </div>
                </div>
                {/* {PASSWORD} */}
                <div>
                    ...
                    <div className='relative'>
                        ...
                        <span onClick={() => setShowpassword(!showpassword)} className='absolute inset-y-0 end-2 grid place-items-center px-4'><LuEye className='h-4 w-4 text-gray-400'/></span>
                    </div>
                </div>
