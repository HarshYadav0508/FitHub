...
const Card = ({ item }) => {
  ...
  return (
    <div className='shadow-lg hover:-translate-y-2 duration-200 cursor-pointer rounded-lg p-3 flex flex-col justify-between border border-secondary overflow-hidden m-4'>
        ...
        <div className='p-4'>
            ...
            <p className='text-gray-600 mb-2'>Total Registered: {totalEnrolled}</p>
